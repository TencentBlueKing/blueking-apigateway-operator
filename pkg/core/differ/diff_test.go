...
var _ = Describe("configDiffer", func() {
	...
	Describe("diffPluginMetadatas", func() {
		...
		BeforeEach(func() {
			differ = NewConfigDiffer()
			newPms = map[string]*entity.PluginMetadata{
				"test-plugin1": entity.NewPluginMetadata("test-plugin1", map[string]interface{}{
					"log-format": map[string]interface{}{
						"remote_addr": "$remote_addr",
					},
				}),
				"test-plugin2": entity.NewPluginMetadata("test-plugin2", map[string]interface{}{
					"log-format": map[string]interface{}{
						"remote_addr": "$remote_addr",
					},
				}),
				"test-plugin4": entity.NewPluginMetadata("test-plugin4", map[string]interface{}{
					"log-format": map[string]interface{}{
			...
			oldPms = map[string]*entity.PluginMetadata{
				...
				"test-plugin3": entity.NewPluginMetadata("test-plugin3", map[string]interface{}{
					"log-format": map[string]interface{}{
						"remote_addr": "$remote_addr",
					},
				}),
