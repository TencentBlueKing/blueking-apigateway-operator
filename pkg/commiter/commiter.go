...
func (c *Commiter) listResources(
	...
	retList := make([]*v1beta1.BkGatewayResource, 0, len(resourceList.Items))
...
func (c *Commiter) listStreamResources(
	...
	retList := make([]*v1beta1.BkGatewayStreamResource, 0, len(resourceList.Items))
	for ind := range resourceList.Items {
		retList = append(retList, &resourceList.Items[ind])
	}
	return retList, nil
...
func (c *Commiter) listServices(
	...
	retList := make([]*v1beta1.BkGatewayService, 0, len(serviceList.Items))
...
func (c *Commiter) listPluginMetadatas(
	...
	retList := make([]*v1beta1.BkGatewayPluginMetadata, 0, len(pluginMetadataList.Items))
...
func (c *Commiter) listSSLs(ctx context.Context, stageInfo registry.StageInfo) ([]*v1beta1.BkGatewayTLS, error) {
	...
	retList := make([]*v1beta1.BkGatewayTLS, 0, len(sslList.Items))
